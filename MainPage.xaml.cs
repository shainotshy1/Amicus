...
namespace AmicusBread
{
    public partial class MainPage : ContentPage
    {
        ...
        private void Checkout(object sender, EventArgs e)
        {
            ...
            if (checkoutTimes == 1)
            {
                DisplayAlert("Checkout Baked Goods", "You can not edit your order after going to the checkout page. Press Checkout a second time to purchase your baked goods.", "OK");
            }
